...
План бывает только в режиме «План»: список пунктов пишет планировщик до начала
работы, и им же управляет поток. В режиме «Агент» плана нет — агент работает
одним циклом без план-карточки. Здесь мы превращаем план потока в событие
карточки для ленты.
